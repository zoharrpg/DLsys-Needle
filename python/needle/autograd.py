...
def topo_sort_dfs(node, visited, topo_order):
    ...
    if node not in visited:
      visited.add(node)
      for current in node.inputs:
        topo_sort_dfs(current,visited,topo_order)
